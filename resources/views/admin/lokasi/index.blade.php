<x-layouts.admin title="Manajemen Lokasi">
     ...
     <dialog id="edit_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama lokasi" class="input input-bordered w-full" value="" id="edit_lokasi_name" name="nama_lokasi" />
            </div>
            <div class="modal-action">
                <button class="btn btn-primary" type="submit">Simpan</button>
    ...
    <script>
        function openEditModal(button) {
            ...
            document.getElementById("edit_lokasi_name").value = nama;
