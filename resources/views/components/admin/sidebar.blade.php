        ...
        <ul class="menu w-full grow gap-1">
            ...
            <li class="{{ request()->routeIs('admin.tipe-tikets.*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('admin.tipe-tikets.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Tipe Tiket">
                    <!-- icon Tipe Tiket -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M21 7V5a2 2 0 0 0-2-2H5A2 2 0 0 0 3 5v2H1v10a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V7h-2zM7 12a2 2 0 1 1 0-4a2 2 0 0 1 0 4zm10 4H7v-2h10v2z" />
                    </svg>
